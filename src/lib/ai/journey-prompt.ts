...
## Revenue Guardrail (MANDATORY)
The SUM of ALL impactProjections.potentialImpact values MUST NOT exceed 40% of the company's estimated annual revenue (shown in Business Data above). If the company has no customers or no stated revenue, cap total impact at a conservative, stage-appropriate ceiling:
- Pre-launch / 0 customers: max $50K total across all projections
- First customers (1-20): max $200K total
- Growing (21-200): max 40% of estimated annual revenue
- Scaling (200+): max 40% of estimated annual revenue
The same cap applies to confrontationInsights businessImpact values. Show your math — inflated projections destroy credibility. Use the company's ACTUAL numbers, not hypothetical prospect counts.
